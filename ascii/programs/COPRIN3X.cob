        ...
        FILE-CONTROL.
           SELECT PRINTER-MASTER ASSIGN TO "CoPrintersRemote3"
               ORGANIZATION IS INDEXED
               LOCK MANUAL
               ACCESS MODE IS DYNAMIC
               RECORD KEY IS PRNT-KEY
               FILE STATUS IS WS-PRINTERS-STATUS.
           SELECT PRINTER-ASCII ASSIGN TO "CoPrintersRemote3ASCII"
               FILE STATUS IS WS-PRINTERS-STATUS.
      *
        DATA DIVISION.
        FILE SECTION.
      ...
      *
       ...
       A-001.
           MOVE 0810 TO POS.
           DISPLAY "** PRINTERS CO3 EXPORT / IMPORT OF DATA **" AT POS
           MOVE 1010 TO POS
