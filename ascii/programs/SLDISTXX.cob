        ...
        FILE-CONTROL.
           SELECT DISTRIBUTIONS ASSIGN TO "SlDistTot"
      ...
      *
       ...
       A-001.
           MOVE 0810 TO POS.
           DISPLAY "** SLDIST EXPORT / IMPORT OF DATA **" AT POS
           MOVE 1010 TO POS
