        ...
        FILE-CONTROL.
           SELECT TOOLKITS ASSIGN TO "BmMaster"
      ...
      *
       ...
       A-001.
           MOVE 0810 TO POS.
           DISPLAY "** TOOLKITS EXPORT / IMPORT OF DATA **" AT POS
           MOVE 1010 TO POS
