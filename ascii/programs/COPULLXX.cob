        ...
        FILE-CONTROL.
           SELECT PULLER-MASTER ASSIGN TO "CoPullers"
               ORGANIZATION IS INDEXED
               LOCK MANUAL
               ACCESS MODE IS DYNAMIC
               RECORD KEY IS PU-KEY
               FILE STATUS IS WS-PULLERS-STATUS.
           SELECT PULLER-ASCII ASSIGN TO 
                            "CoPullersASCII"
               FILE STATUS IS WS-PULLERS-STATUS.
      *
        DATA DIVISION.
      ...
      *
       ...
       A-001.
           MOVE 0810 TO POS.
           DISPLAY "** PULLERS EXPORT / IMPORT OF DATA **" AT POS
           MOVE 1010 TO POS
