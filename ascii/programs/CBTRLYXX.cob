        ...
        FILE-CONTROL.
           SELECT CBTRANS-LY-FILE ASSIGN TO "CbTransLy"
               ORGANIZATION IS INDEXED
               LOCK MANUAL
               ACCESS MODE IS DYNAMIC
               RECORD KEY IS CBTRANS-LY-KEY
      ...
      *
       ...
       A-001.
           MOVE 0810 TO POS.
           DISPLAY "** CBTRANSLY EXPORT / IMPORT OF DATA **" AT POS
           MOVE 1010 TO POS
      ...
      *
        ...
        BE-005.
           ...
           DISPLAY CBTRANS-LY-DATE.
           
           ADD 1 TO WS-COUNT.

           MOVE CBTRANS-LY-REC    TO ASCII-REC.
        BE-010.
      *     WRITE ASCII-REC
      *           INVALID KEY
