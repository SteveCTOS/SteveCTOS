...
parser.add_argument('-f', '--file',     default='/ctools/bin/Invoice.pdf')
parser.add_argument('-F', '--From',     default='Development Linux <Dev@Christensen.co.za>')
parser.add_argument('-s', '--subject',  default='Test subject of Mailgun from python')
...
#The -t in argparse arguments was missing
#
