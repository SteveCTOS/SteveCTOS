           ...
           IF WS-LOAN-1-10 = "FNB OB TRF"
            IF WS-LOAN-3-10 = "CTN-CTJ LO"
             IF WS-LOAN-4-26 = "AN PD                     "
              ...
              PERFORM UPDATE-CASHBOOK
              GO TO RCF-030.
      * MBL=4  LOANS TO MBL FROM CTJ
           IF WS-LOAN-1-10 = "FNB OB TRF"
            IF WS-LOAN-4-26 = "CTJ-MBL LOAN              "
             IF WS-CO-NUMBER = 1
              MOVE " *" TO BANK-CAMS-FOUND
              PERFORM CIM-950
              MOVE " Loan To Company                             "
                  TO WS-NARRATIVE 
              MOVE "75-040-30-00" TO CBTRANS-ACCOUNT-NUMBER
              MOVE WS-CAMS-AMOUNT TO WS-BANK-NETT-AMT
              PERFORM WRITE-LOAN-CBTRANS
              PERFORM UPDATE-CASHBOOK
              GO TO RCF-030.
           IF WS-LOAN-1-10 = "FNB OB TRF"
            IF WS-LOAN-3-10 = "MBL-CTJ LO"
             IF WS-LOAN-4-26 = "AN PD                     "
              IF WS-CO-NUMBER = 1
              MOVE " *" TO BANK-CAMS-FOUND
              PERFORM CIM-950
           ...
           IF WS-LOAN-1-10 = "FNB OB TRF"
            IF WS-LOAN-3-10 = "MBL-CTJ LO"
             IF WS-LOAN-4-26 = "AN                        "
              ...
              GO TO RCF-030.
           IF WS-LOAN-1-10 = "FNB OB TRF"
            IF WS-LOAN-4-26 = "CTJ-MBL LOAN PD           "
             IF WS-CO-NUMBER = 1
              MOVE " *" TO BANK-CAMS-FOUND
              PERFORM CIM-950
              MOVE " Loan Paid                                   "
      ...
      * LOANS PROCESSED IN MBL
      * MBL=4  LOAN FROM MBL TO CTJ
           IF WS-LOAN-1-10 = "FNB OB TRF"
            IF WS-LOAN-4-26 = "MBL-CTJ LOAN              "
             IF WS-CO-NUMBER = 4
              MOVE " *" TO BANK-CAMS-FOUND
              PERFORM CIM-950
              MOVE " Loan To Company                             "
      ...
      *SFJ
           ...
           IF WS-NAR-1-21 = "F/CARD COMRENTAL00937"
            IF WS-CAMS-AMOUNT < 0
              ...
              PERFORM UPDATE-CASHBOOK
              GO TO RCF-030.
           IF WS-NAR-1-21 = "F/CARD COMCOMMIS00937"
            IF WS-CAMS-AMOUNT < 0
              PERFORM ADD-BANK-VAT
              MOVE " *" TO BANK-CAMS-FOUND
              PERFORM CIM-950
      ...
      * CTJ
           ...
           IF WS-NAR-1-21 = "F/CARD COMRENTAL00052"
            IF WS-CAMS-AMOUNT < 0
              ...
              PERFORM UPDATE-CASHBOOK
              GO TO RCF-030.
           IF WS-NAR-1-21 = "F/CARD COMCOMMIS00052"
            IF WS-CAMS-AMOUNT < 0
              PERFORM ADD-BANK-VAT
              MOVE " *" TO BANK-CAMS-FOUND
              PERFORM CIM-950
      ...
      *CTN
           ...
           IF WS-NAR-1-21 = "F/CARD COMRENTAL00483"
            IF WS-CAMS-AMOUNT < 0
              ...
              PERFORM UPDATE-CASHBOOK
              GO TO RCF-030.
           IF WS-NAR-1-21 = "F/CARD COMCOMMIS00483"
            IF WS-CAMS-AMOUNT < 0
              PERFORM ADD-BANK-VAT
              MOVE " *" TO BANK-CAMS-FOUND
              PERFORM CIM-950
