      ...
      *
       ...
       01  WS-REPORT-DATE-STRIP.
           ...
           03  WS-STRIP2          PIC X(21).
           03  WS-STRIP3          PIC X(2).
      **************************************************************
      * FORMS WORK FIELDS
      **************************************************************
       Copy "FormsInfo".
      ...
      *
       ...
       FILL-150.
            ...
            MOVE 1 TO F-CBFIELDLENGTH.
            PERFORM READ-FIELD-ALPHA.
            IF F-NAMEFIELD NOT = DR-SUPPLY-Y-N
               PERFORM PREP-DAILY.
