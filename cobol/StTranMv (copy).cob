      ...
      *
        ...
        A-000.
           ...
           ELSE
            ...
            IF WS-STAT1 NOT = 0
               MOVE "ERROR ON OPEN OUTPUT FILE" TO WS-MESSAGE
      ...
      *     PERFORM ERROR-MESSAGE.
           ...
           IF WS-ACCEPT = "E"
            ...
            IF WS-STAT1 NOT = 0
               ...
               EXIT PROGRAM
           ELSE
              MOVE "SUCCESS IN OPENING THE OUTPUT FILE" TO WS-MESSAGE
              PERFORM ERROR1-MESSAGE
              OPEN I-O STOCK1-TRANS-FILE
            IF WS-STAT1 NOT = 0
               MOVE "ERROR ON OPEN INPUT FILE" TO WS-MESSAGE
               PERFORM ERROR1-MESSAGE
               MOVE WS-STAT1 TO WS-MESSAGE
               PERFORM ERROR-MESSAGE
               PERFORM C-END
              ...
              MOVE "SUCCESS IN OPENING THE INTPUT FILE" TO WS-MESSAGE
              PERFORM ERROR1-MESSAGE
           MOVE WS-STAT1 TO WS-MESSAGE
           PERFORM ERROR-MESSAGE.
