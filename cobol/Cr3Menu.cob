      ...
      *     CANCEL WS-PROGRAM.
           ...
           IF WS-ANSWER = "35"
            ...
            IF WS-ANSWER = " 1"
                MOVE "CrMastRp" TO WS-PROGRAM.
            IF WS-ANSWER = " 2"
                MOVE "CrRemiRp" TO WS-PROGRAM.
            IF WS-ANSWER = " 3"
                MOVE "CrPaymRp" TO WS-PROGRAM.
            IF WS-ANSWER = " 4"
                MOVE "CrCheqRp" TO WS-PROGRAM.
            IF WS-ANSWER = " 5"
                MOVE "CrCheqMt" TO WS-PROGRAM.
            IF WS-ANSWER = " 6"
                MOVE "CrAgeARp" TO WS-PROGRAM.
            IF WS-ANSWER = " 7"
                MOVE "CrAgeTRp" TO WS-PROGRAM.
            IF WS-ANSWER = " 8"
                MOVE "CrJnAnRp" TO WS-PROGRAM.
            IF WS-ANSWER = " 9"
                MOVE "CrInCrRp" TO WS-PROGRAM.
            IF WS-ANSWER = "10"
                MOVE "CrLablRp" TO WS-PROGRAM.
            IF WS-ANSWER = "11"
                MOVE "CrFBCRp" TO WS-PROGRAM.
            IF WS-ANSWER = "12"
                MOVE "CrFBCPRp" TO WS-PROGRAM.
            IF WS-ANSWER = "13"
                MOVE "CrAliaRp" TO WS-PROGRAM.
            IF WS-ANSWER = "14"
                MOVE "CrLaPuRp" TO WS-PROGRAM.
            IF WS-ANSWER = "15"
                MOVE "CrNmFxRp" TO WS-PROGRAM.
            IF WS-ANSWER = "16"
                MOVE "CrRemiEM" TO WS-PROGRAM.
           Call Ws-Program Using Ws-Linkage.
           PERFORM CLEAR-SCREEN
           CANCEL WS-PROGRAM
           PERFORM DISPLAY-FORM
