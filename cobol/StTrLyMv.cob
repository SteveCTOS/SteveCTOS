      ...
      *
        ...
        A-000.
           ...
           IF WS-ACCEPT = "E"
              OPEN OUTPUT STOCK1-TRANSLY-FILE
           ELSE
              OPEN I-O STOCK1-TRANSLY-FILE.
      ...
      *
        ...
        BE-005.
           ...
           MOVE STOCK-TRANSLY-REC  TO STOCK1-TRANSLY-REC.
      ...
      *
        B-IMPORT SECTION.
        BI-005.
           READ STOCK1-TRANSLY-FILE NEXT WITH LOCK
               AT END 
             GO TO BI-EXIT.
           ...
           MOVE STOCK1-TRANSLY-REC    TO STOCK-TRANSLY-REC.
        BI-010.
      ...
      *      MOVE SPACES TO STOCK-TRANSLY-REC.
