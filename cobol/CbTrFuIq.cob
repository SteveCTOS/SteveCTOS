      ...
      *     03  WS-GLPARAMETER-ST2     PIC X.
       ...
       01  HEAD1.
           ...
           "** CASHBOOK FUTURE TRANSACTION INQUIRY **".
      ...
      *
       ...
       CONTROL-000.
           ...
           MOVE 0310 TO POS
           DISPLAY "** CASH-BOOK FUTURE TRANSACTION INQUIRY PROGRAM **"
           AT POS
           MOVE 0410 TO POS
           DISPLAY "**************************************************"
           AT POS.
      ...
      *
       ...
       RALT-000.
           OPEN I-O CBTRANS-FILE.
           IF WS-CBTRANS-ST1 NOT = 0
              MOVE "CBTRANS BUSY ON OPENING, RALT-000, 'ESC' TO RETRY."
               TO WS-MESSAGE
              PERFORM ERROR-MESSAGE
              CLOSE CBTRANS-FILE
              GO TO RALT-000.
      ...
      *
       ...
       RD-015.
           ...
           IF WS-CB-ST1 = 23 OR 35 OR 49
               ...
               GO TO RD-999.
           IF WS-CB-ST1 NOT = 0
               MOVE"CBMASTER RECORD ERROR, RD-015 'ESC' TO RETRY"
               TO WS-MESSAGE
               PERFORM ERROR-MESSAGE
               GO TO RD-015.
       RD-999.
      ...
      *
       ...
       RP-000.
           ...
           IF WS-GLPARAMETER-ST1 = 23 OR 35 OR 49
               DISPLAY "NO GLGPARAMETER RECORD!!!!"
