      ...
      *
       ...
       CONT-015.
           ...
           PERFORM CHECK-DATA-NAMES.
           MOVE WS-VOL-DIR TO LIST-VOL-DIR (SUB-20).
           PERFORM CHECK-BRANCH-DATA-NAMES.
           PERFORM END-OFF.
       CONT-999.
           Exit.
      ...
      *
       ...
       RBC-010.
           READ DATA-FILE
               INVALID KEY NEXT SENTENCE.
           IF WS-DATA-ST1 NOT = 0
               MOVE "BRANCH DATAFILE BUSY ON READ, 'ESC' TO RE-TRY."
               TO WS-MESSAGE
               PERFORM ERROR-MESSAGE
               GO TO RBC-010.
       RBC-020.
      ...
      *     ACCEPT WS-COMPANY-UPDATE AT POS.
           ...
           IF LIST-NAME (SUB-20) = " "
            ...
            "PLEASE ENTER A COMPANY THAT EXISTS, PLEASE RE-ENTER."
               ...
               GO TO SB-005.
           PERFORM ERROR-020.
           IF LIST-NAME (SUB-20) = WS-CO-NUMBER
               MOVE 
           ...
           ADD 19 TO POS
           DISPLAY LIST-NAME (SUB-20) AT POS
           MOVE 0929 TO POS
           DISPLAY List-VOL-DIR (SUB-20) AT POS.
       SB-020.
           MOVE 1010 TO POS
      ...
      *         PERFORM ERROR-MESSAGE
      *         MOVE WS-STOCK-ST2 TO WS-MESSAGE
      *         PERFORM ERROR-MESSAGE
      ...
      *
       ...
       RSN-005. 
           READ STOCKCHANGE-MASTER NEXT
             AT END 
               GO TO RSN-900.
           IF WS-STCHANGE-ST1 = 23 OR 35 OR 49 OR 51
               MOVE 0 TO WS-STCHANGE-ST1
