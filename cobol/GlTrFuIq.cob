      ...
      *     03  WS-GLPARAMETER-ST2     PIC X.
       ...
       01  HEAD1.
           ...
           "** GLMASTER FUTURE TRANSACTION INQUIRY **".
       ...
       01  HEAD2-3.
           ...
           03  HEAD2-3-F      PIC X VALUE " ".
           03  H3-PERIOD-READ PIC X(111).
       01  HEAD3.
      ...
      *
       ...
       CONTROL-000.
           ...
           MOVE 0310 TO POS
           DISPLAY "** G/LEDGER FUTURE TRANSACTION INQUIRY **" AT POS
           MOVE 0410 TO POS
           DISPLAY "*****************************************" AT POS.
       CONTROL-003.
           Copy "PrinterAccept".
      ...
      *
       ...
       RD-015.
           ...
           IF WS-GLMAST-ST1 NOT = 0
               MOVE"GLMASTER RECORD ERROR, RD-015 'ESC' TO RETRY"
               TO WS-MESSAGE
