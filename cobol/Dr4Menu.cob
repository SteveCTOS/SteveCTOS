      ...
      *
       ...
       GET-010.
            ...
            IF WS-ANSWER NOT = " 1" AND NOT = " 2" AND NOT = " 3"
                     ...
                     AND NOT = " 7" AND NOT = " 8" AND NOT = "XX"
                MOVE "Selection Must Be Between 1 & 8, Re-Enter."
                TO WS-MESSAGE
                PERFORM ERROR-000
      ...
      *     CANCEL WS-PROGRAM.
           ...
           IF WS-ANSWER = " 1"
               MOVE "DrMaster" TO WS-PROGRAM.
           IF WS-ANSWER = " 2"
               MOVE "DrTrans"  TO WS-PROGRAM.
           IF WS-ANSWER = " 3"
               MOVE "DrNoChMt" TO WS-PROGRAM.
           IF WS-ANSWER = " 4"
               MOVE "DrAdSlAc" TO WS-PROGRAM.
           IF WS-ANSWER = " 5"
               MOVE "DrAnChck" TO WS-PROGRAM.
           IF WS-ANSWER = " 6"
               MOVE "DrAgeTmp" TO WS-PROGRAM.
           IF WS-ANSWER = " 7"
               MOVE "DrRepRst" TO WS-PROGRAM.
           IF WS-ANSWER = " 8"
               MOVE "DrMasOld" TO WS-PROGRAM.
