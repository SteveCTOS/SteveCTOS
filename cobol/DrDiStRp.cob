      ...
      *
       ...
       01  HEAD1.
           ...
           "SPECIAL DISCOUNTS BY STOCK/ACCOUNT NUMBER".
      ...
      *
       ...
       CONTROL-000.
           ...
           MOVE 310 TO POS
           DISPLAY "** SPECIAL DISCOUNT BY STOCK/ACCOUNT REPORT**"
            AT POS
           MOVE 410 TO POS
           DISPLAY "*********************************************"
            AT POS.
      ...
      *
       ...
       PRR-000.
           MOVE WS-ANSWER1 TO STDISC-STOCKNUMBER
       ...
       PRR-005.
           ...
           IF STDISC-STOCKNUMBER < WS-ANSWER1
              GO TO PRR-005.
           IF STDISC-STOCKNUMBER > WS-ANSWER2
              PERFORM PRINT-TOTALS
              GO TO PRR-999.
           ...
           IF WS-STORE = " "
              MOVE STDISC-STOCKNUMBER TO WS-STORE
              GO TO PRR-007.
       PRR-006.
            IF STDISC-STOCKNUMBER = WS-STORE
               GO TO PRR-010.
       ...
       PRR-007.
            ...
            IF WS-STOCK-ST1 = 23 OR 35 OR 49
               ...
               MOVE "UNKNOWN STOCK" TO ST-DESCRIPTION1
       ...
       PRR-020.
           ...
           MOVE 2610 TO POS
           DISPLAY "DebtorNumber Being Read:" AT POS
           ADD 25 TO POS
           DISPLAY DR-NAME AT POS.

           PERFORM CHECK-DISCOUNT.
           MOVE DR-ACCOUNT-NUMBER        TO D-ACC
