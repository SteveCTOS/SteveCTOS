      ...
      *
        ...
        GET-001.
            ...
            PERFORM READ-DEBTOR.
            IF NEW-DEBTORNO = "Y"
               MOVE "ACCOUNT NUMBER NOT VALID" TO WS-MESSAGE
        ...
        GET-005.
            ...
            MOVE DR-CREDIT-LIMIT TO F-EDNAMEFIELDACC
            MOVE 7               TO F-CBFIELDLENGTH
      ...
      *
       ...
       DDR-010.
            ...
            MOVE "DEBTORS BUSY ON DELETE, 'ESC' TO RETRY." TO WS-MESSAGE
                PERFORM ERROR-MESSAGE
      ...
      *
       ...
       RDNX-005. 
           ...
           IF WS-DEBTOR-ST1 = 23 OR 35 OR 49 OR 51
               MOVE "DEBTOR BUSY ON READ-NEXT, PRESS 'ESC' TO RETRY"
               TO WS-MESSAGE
               PERFORM ERROR1-000
               MOVE WS-DEBTOR-ST1 TO WS-MESSAGE
               PERFORM ERROR-MESSAGE
               ...
               GO TO RDNX-005.
           IF WS-DEBTOR-ST1 NOT = 0
               MOVE "DEBTOR BUSY ON RDNXSTART, IN 1 SEC GOING TO RETRY."
               TO WS-MESSAGE
               PERFORM ERROR1-000
               MOVE WS-DEBTOR-ST1 TO WS-MESSAGE
               PERFORM ERROR-000
      ...
      *
       ...
       RDPR-005. 
           ...
           IF WS-DEBTOR-ST1 = 23 OR 35 OR 49 OR 51
               ...
               GO TO RDPR-005.
           IF WS-DEBTOR-ST1 NOT = 0
               MOVE "DEBTOR BUSY ON RDPRSTART, IN 1 SEC GOING TO RETRY."
               TO WS-MESSAGE
               PERFORM ERROR1-000
               MOVE WS-DEBTOR-ST1 TO WS-MESSAGE
               PERFORM ERROR-000
