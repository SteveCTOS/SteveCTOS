      ...
      *
       ...
       GET-001.              
            ...
            PERFORM READ-STOCK.
            IF NEW-STOCKNO = "Y"
               MOVE "ENTER A VALID STOCK NUMBER, 'ESC' TO RETRY."
               TO WS-MESSAGE
       ...
       RSN-005. 
           READ STOCK-MASTER NEXT WITH LOCK
             AT END 
               ...
               GO TO RSN-999.
           IF WS-STOCK-ST1 = 23 OR 35 OR 49
               MOVE "STOCK FILE BUSY READ-NEXT-23, PRESS 'ESC' TO EXIT."
               TO WS-MESSAGE
               PERFORM ERROR1-000
               MOVE WS-STOCK-ST1 TO WS-MESSAGE
               PERFORM ERROR-MESSAGE
               ...
               GO TO RSN-999.
           IF WS-STOCK-ST1 NOT = 0
               MOVE "STOCK FILE BUSY READ-NEXT, PRESS 'ESC' TO EXIT."
               TO WS-MESSAGE
               PERFORM ERROR1-000
               MOVE WS-STOCK-ST1 TO WS-MESSAGE
               PERFORM ERROR-MESSAGE
       ...
       RSPREV-005. 
           READ STOCK-MASTER PREVIOUS WITH LOCK
            ...
            MOVE "END OF PREVIOUS PAGE SEQUENCE, ENTER A NEW IDENTIFIER"
               ...
               GO TO RSPREV-999.
           IF WS-STOCK-ST1 = 23 OR 35 OR 49
               MOVE "STOCK FILE BUSY READ-PREV-23, PRESS 'ESC' TO EXIT."
               TO WS-MESSAGE
               PERFORM ERROR1-000
               MOVE WS-STOCK-ST1 TO WS-MESSAGE
               PERFORM ERROR-MESSAGE
