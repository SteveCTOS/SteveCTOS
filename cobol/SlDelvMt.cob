      ...
      *
       ...
       GET-001.
        ...
        GET-003.
            ...
            PERFORM WRITE-FIELD-INDEX1.
        GET-005.
            MOVE "DELDESC" TO F-FIELDNAME.
            MOVE 7 TO F-CBFIELDNAME.
            MOVE DELIV-DESC TO F-NAMEFIELD.
      ...
      *
       ...
       FILL-001.
            ...
            MOVE 20 TO F-CBFIELDLENGTH.
            PERFORM READ-FIELD-ALPHA.
            MOVE F-NAMEFIELD TO DELIV-DESC.
            IF F-EXIT-CH = X"07"
               PERFORM CLEAR-FORM
               GO TO FILL-999.
            IF DELIV-DESC = " "
       ...
       RPREV-005.
           ...
           IF PA-TYPE NOT = 3
              MOVE "END OF PREV-PAGE SEQUENCE, ENTER A NEW IDENTIFIER."
               ...
               GO TO RPREV-999.
           IF WS-SLPARAMETER-ST1 = 23 OR 35 OR 49
               MOVE "PARAMETER BUSY ON READ-PREVIOUS, 'ESC' TO RETRY."
               TO WS-MESSAGE
               PERFORM ERROR1-000
               MOVE WS-SLPARAMETER-ST1 TO WS-MESSAGE
               PERFORM ERROR-MESSAGE
