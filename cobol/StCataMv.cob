        ...
        FILE-CONTROL.
           SELECT STCAT-MASTER ASSIGN TO Ws-StCatalogue
               ...
               ALTERNATE RECORD KEY IS STCAT-PAGE-NUM WITH DUPLICATES
               FILE STATUS IS WS-STCAT-STATUS.
                     
           SELECT STCAT1-MASTER ASSIGN TO Ws-StTransTemp
               ORGANIZATION IS INDEXED
               LOCK MANUAL
               ACCESS MODE IS DYNAMIC
               RECORD KEY IS STCAT1-KEY
               ALTERNATE RECORD KEY IS STCAT1-PAGE-NUM WITH DUPLICATES
               FILE STATUS IS WS-STCAT-STATUS.
      *
        DATA DIVISION.
        FILE SECTION.
           COPY "ChlfdStCatalogue".
           COPY "ChlfdStCatalogue1".
      *
      ...
      *
       ...
       A-AC001.
           MOVE 0820 TO POS.
           DISPLAY "** ST-CATALOGUE EXPORT / IMPORT OF DATA **" AT POS
           MOVE 1010 TO POS
           DISPLAY 
      ...
      *
        A-INIT SECTION.
        A-000.
           MOVE Ws-StCatalogue TO WS-MESSAGE
      ...
      *     PERFORM ERROR-MESSAGE.
           ...
           IF WS-ACCEPT = "I"
               MOVE " " TO STCAT1-KEY
              START STCAT1-MASTER KEY NOT < STCAT1-KEY.

           IF WS-ACCEPT = "E"
              OPEN OUTPUT STCAT1-MASTER
           ELSE
              OPEN I-O STCAT1-MASTER.
      ...
      *
        ...
        BE-005.
           ...
           DISPLAY STCAT-KEY  AT 1505
           ADD 1 TO WS-COUNT
           DISPLAY WS-COUNT AT 2510.

           MOVE STCAT-RECORD    TO STCAT1-RECORD.
        BE-010.
           WRITE STCAT1-RECORD
                 INVALID KEY
      ...
      *
        B-IMPORT SECTION.
        BI-005.
           READ STCAT1-MASTER NEXT WITH LOCK
               AT END 
             GO TO BI-EXIT.
               
           DISPLAY STCAT1-KEY AT 1505
           ADD 1 TO WS-COUNT
           DISPLAY WS-COUNT AT 2510.
           
           MOVE STCAT1-RECORD    TO STCAT-RECORD.
        BI-010.
           WRITE STCAT-RECORD
                 INVALID KEY
