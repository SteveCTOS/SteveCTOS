      ...
      *
       ...
       GET-001.
            ...
            MOVE NUMERIC-RATE TO F-EDNAMEFIELDPTY
                                 PA-RECORD.
        ...
        GET-003.
            MOVE "BRANCH"  TO F-FIELDNAME.
            MOVE 6         TO F-CBFIELDNAME.
            MOVE PA-RECORD TO F-EDNAMEFIELDPTY.
            MOVE 2         TO F-CBFIELDLENGTH.
            PERFORM WRITE-FIELD-PTY.
        GET-005.
            MOVE "NAME"      TO F-FIELDNAME.
            MOVE 4           TO F-CBFIELDNAME.
            MOVE BRANCH-NAME TO F-NAMEFIELD.
      ...
      *
       ...
       FILL-001.
            ...
            MOVE 3           TO F-CBFIELDLENGTH.
            PERFORM READ-FIELD-ALPHA.
            MOVE F-NAMEFIELD TO BRANCH-NAME.
            IF F-EXIT-CH = X"07"
               PERFORM CLEAR-FORM
               GO TO FILL-999.
            IF DELIV-DESC = " "
