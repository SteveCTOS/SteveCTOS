      ...
      *
       ...
       FILL-001.
            IF WS-END = "Y"
                GO TO FILL-999.
            IF NEW-STOCKNO NOT = "Y" 
                MOVE ST-STOCKNUMBER TO WS-CATEGORY.
            IF ST-CATEGORY NOT = WS-CATEGORY
               MOVE
           "The STOCK-NUMBER AND CATEGORY ARE NOT EQUAL, PLEASE CHECK."
               TO WS-MESSAGE
               PERFORM ERROR-MESSAGE
               GO TO FILL-015.
            
            IF ST-FOREIGNCOST > 0
             IF ST-DUTYTARIFF NOT > 0
               MOVE 
           "FOREIGN ITEMS MUST HAVE DUTY TARIFF ENTERED, RE-ENTER."
                TO WS-MESSAGE
                PERFORM ERROR-000
                GO TO FILL-194.
        ...
        FILL-085.
            ...
            MOVE NUMERIC-RATE TO F-EDNAMEFIELDAMOUNT
                                 ST-AVERAGECOST.
            PERFORM WRITE-FIELD-AMOUNT.
            IF ST-AVERAGECOST NOT > 0
               MOVE "THE COST MUST BE ENTERED, 'ESC' TO RE-ENTER"
               TO WS-MESSAGE
               PERFORM ERROR-000
               GO TO FILL-085.
      ...
      *      IF NEW-STOCKNO = "N"
        ...
        FILL-191.
            ...
            IF ST-FOREIGNCOST > 0
             IF ST-DUTYPERCENT NOT > 0
               MOVE "THIS IS A FOREIGN ITEM, IS THE DUTY% CORRECT??"
                TO WS-MESSAGE
                PERFORM ERROR-000.
      ...
      *
       ...
       RSTCH-005.
           ...
           IF STCH-TYPE-OF-CHANGE = "R"
               MOVE
            "RUN A BRANCH UPDATE FIRST AS THIS ITEM HAS BEEN RENAMED."
              TO WS-MESSAGE
               PERFORM ERROR-MESSAGE
      ...
      *
       ...
       RSN-005. 
           ...
           IF WS-STOCK-ST1 = 23 OR 35 OR 49 OR 51
               MOVE 0 TO WS-STOCK-ST1
               MOVE "STOCK FILE BUSY ON READ-NEXT, PRESS 'ESC' TO RETRY"
               TO WS-MESSAGE
               PERFORM ERROR-MESSAGE
               GO TO RSN-005.
           IF WS-STOCK-ST1 NOT = 0
