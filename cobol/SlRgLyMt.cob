      ...
      *DISPLAY OF REGISTER FILE FOR ALL CODES EXCEPT 7
        GET-005.
            IF INCR-LY-TRANS = 7
               GO TO GET-020.
            ...
            MOVE 11               TO F-CBFIELDNAME.
            MOVE INCR-LY-PART-ORDERS TO F-NAMEFIELD.
            MOVE 1                TO F-CBFIELDLENGTH.
            PERFORM WRITE-FIELD-ALPHA.
      ...
      *START OF DISPLAY FOR B/MATERIAL REGISTER INFO
       GET-020.
            PERFORM FILL-2000.
            IF NEW-ORDER = "Y"
               GO TO GET-999.
       GET-025.
            IF F-FORMNAME NOT = "SlRgBmIq"
               MOVE "SlRgBmIq" TO F-FORMNAME
               PERFORM OPEN-010 THRU OPEN-020
               PERFORM DISPLAY-FORM.
            ...
            MOVE 7            TO F-CBFIELDNAME.
            MOVE INCR-LY-KITNAME TO F-NAMEFIELD.
            MOVE 15           TO F-CBFIELDLENGTH.
            PERFORM WRITE-FIELD-ALPHA.

            MOVE "KITQTY"    TO F-FIELDNAME.
            MOVE 6           TO F-CBFIELDNAME.
            MOVE INCR-LY-KITQTY TO F-EDNAMEFIELDGROUP.
            MOVE 3           TO F-CBFIELDLENGTH.
            PERFORM WRITE-FIELD-GROUP.

            MOVE "KITSHPDQTY"    TO F-FIELDNAME.
            MOVE 10              TO F-CBFIELDNAME.
            MOVE INCR-LY-KITSHPDQTY TO F-EDNAMEFIELDGROUP.
            MOVE 3               TO F-CBFIELDLENGTH.
            PERFORM WRITE-FIELD-GROUP.

            MOVE "KITDESC1"    TO F-FIELDNAME.
            MOVE 8             TO F-CBFIELDNAME.
            MOVE INCR-LY-KITDESC1 TO F-NAMEFIELD.
            MOVE 20            TO F-CBFIELDLENGTH.
            PERFORM WRITE-FIELD-ALPHA.

            MOVE "KITDESC2"    TO F-FIELDNAME.
            MOVE 8             TO F-CBFIELDNAME.
            MOVE INCR-LY-KITDESC2 TO F-NAMEFIELD.
            MOVE 20            TO F-CBFIELDLENGTH.
            PERFORM WRITE-FIELD-ALPHA.

            MOVE "KITPRICE"    TO F-FIELDNAME.
            MOVE 8             TO F-CBFIELDNAME.
            MOVE INCR-LY-KITPRICE TO F-EDNAMEFIELD99Mil.
            MOVE 11            TO F-CBFIELDLENGTH.
            PERFORM WRITE-FIELD-99Mil.

            MOVE "KITCOMMENT"    TO F-FIELDNAME.
            MOVE 10              TO F-CBFIELDNAME.
            MOVE INCR-LY-KITCOMMENT TO F-NAMEFIELD.
            MOVE 40              TO F-CBFIELDLENGTH.
            PERFORM WRITE-FIELD-ALPHA.
       GET-999.
            EXIT.
      ...
      *
       FILL-000.
            ...
            MOVE 2910 TO POS.
            DISPLAY "THESE ARE P/SLIP, INV, QUOTE, C/NOTE FIELDS."
            AT POS.
      ...
      *
       ...
       FILL-2001.
           ...
           IF INCR-LY-TRANS NOT = 7
               GO TO FILL-001.
           MOVE 2910 TO POS.
           DISPLAY "THESE ARE B/MATERIAL FIELDS" AT POS.
       ...
       FILL-2075.
            ...
            MOVE 15          TO F-CBFIELDLENGTH.
            PERFORM READ-FIELD-ALPHA.
            MOVE F-NAMEFIELD TO INCR-LY-KITNAME.
            IF F-EXIT-CH = X"07"
               PERFORM CLEAR-FORM
               GO TO FILL-999.
            IF F-EXIT-CH = X"0C"
       ...
       FILL-2080.
            ...
            MOVE F-NAMEFIELD TO ALPHA-RATE
            PERFORM DECIMALISE-RATE
            MOVE NUMERIC-RATE TO INCR-LY-KITQTY
                                 F-EDNAMEFIELDGROUP.
            PERFORM WRITE-FIELD-GROUP.
            IF F-EXIT-CH = X"07"
               PERFORM CLEAR-FORM
       ...
       FILL-2085.
            ...
            MOVE F-NAMEFIELD TO ALPHA-RATE
            PERFORM DECIMALISE-RATE
            MOVE NUMERIC-RATE TO INCR-LY-KITSHPDQTY
                                 F-EDNAMEFIELDGROUP.
            PERFORM WRITE-FIELD-GROUP.
            IF F-EXIT-CH = X"07"
               PERFORM CLEAR-FORM
       ...
       FILL-2090.
            ...
            MOVE 20 TO F-CBFIELDLENGTH.
            PERFORM READ-FIELD-ALPHA.
            MOVE F-NAMEFIELD TO INCR-LY-KITDESC1.
            IF F-EXIT-CH = X"07"
               PERFORM CLEAR-FORM
               GO TO FILL-999.
            IF F-EXIT-CH = X"0C"
       ...
       FILL-2095.
            ...
            MOVE 20 TO F-CBFIELDLENGTH.
            PERFORM READ-FIELD-ALPHA.
            MOVE F-NAMEFIELD TO INCR-LY-KITDESC2.
            IF F-EXIT-CH = X"07"
               PERFORM CLEAR-FORM
               GO TO FILL-999.
            IF F-EXIT-CH = X"0C"
       ...
       FILL-2100.
            ...
            MOVE F-NAMEFIELD TO ALPHA-RATE
            PERFORM DECIMALISE-RATE
            MOVE NUMERIC-RATE TO INCR-LY-KITPRICE
                                 F-EDNAMEFIELD99Mil.
            PERFORM WRITE-FIELD-99Mil.
            IF F-EXIT-CH = X"07"
               PERFORM CLEAR-FORM
       ...
       FILL-2105.
            ...
            MOVE 40 TO F-CBFIELDLENGTH.
            PERFORM READ-FIELD-ALPHA.
            MOVE F-NAMEFIELD TO INCR-LY-KITCOMMENT.
            IF F-EXIT-CH = X"07"
               PERFORM CLEAR-FORM
               GO TO FILL-999.
            IF F-EXIT-CH = X"0C"
