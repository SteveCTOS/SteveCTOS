      ...
      *F8-KEY.
       ...
       GET-200.
            ...
            MOVE F-NAMEFIELD  TO ALPHA-RATE
            PERFORM DECIMALISE-RATE
            MOVE NUMERIC-RATE TO WS-ADDONFREIGHT F-EDNAMEFIELDAMOUNT
            MOVE 9            TO F-CBFIELDLENGTH
       ...
       GET-210.
            ...
            MOVE F-NAMEFIELD   TO ALPHA-RATE
            PERFORM DECIMALISE-RATE
            MOVE NUMERIC-RATE  TO WS-POSTADDON F-EDNAMEFIELDAMOUNT
            MOVE 9             TO F-CBFIELDLENGTH
            PERFORM WRITE-FIELD-AMOUNT.
       GET-220.
            MOVE "                   " TO F-NAMEFIELD
            ...
            MOVE F-NAMEFIELD  TO ALPHA-RATE
            PERFORM DECIMALISE-RATE
            MOVE NUMERIC-RATE TO WS-HANDADDON F-EDNAMEFIELDAMOUNT
            MOVE 9            TO F-CBFIELDLENGTH
            PERFORM WRITE-FIELD-AMOUNT.
       GET-230.
            MOVE "                   " TO F-NAMEFIELD
            ...
            MOVE F-NAMEFIELD  TO ALPHA-RATE
            PERFORM DECIMALISE-RATE
            MOVE NUMERIC-RATE TO WS-MISCADDON F-EDNAMEFIELDAMOUNT
            MOVE 9            TO F-CBFIELDLENGTH
            PERFORM WRITE-FIELD-AMOUNT.
      ...
      *
       ...
       RIR-005.
           ...
           IF WS-INCR-ST1 NOT = 0
               MOVE 0 TO WS-INCR-ST1
               MOVE "INV/CR. REGISTER BUSY, RIR-005, 'ESC' TO ETRY."
                TO WS-MESSAGE
               PERFORM ERROR-MESSAGE
               GO TO RIR-005.
           IF INCR-PRINTED = "Y" OR = "L"
      ...
      *
       ...
       RSTT-010.
           ...
           IF WS-STTRANS-ST1 = 10
              ...
              GO TO RSTT-999.
           IF WS-STTRANS-ST1 NOT = 0
              MOVE "ST-TRANS BUSY ON READ, 'ESC' TO RETRY."
              TO WS-MESSAGE
              PERFORM ERROR-MESSAGE
      ...
      *
       ...
       RWST-005.
           ...
           IF WS-STTRANS-ST1 NOT = 0
              ...
              MOVE "ST-TRANS BUSY ON READ - RWST-005" TO WS-MESSAGE
              PERFORM ERROR-MESSAGE
              GO TO RWST-005.
            MOVE B-STOCKNUMBER (SUB-1) TO SPLIT-STOCK
                                          STTR-STOCK-NUMBER.
