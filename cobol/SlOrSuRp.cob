      ...
      *
       ...
       01  PLINE4-1.
           ...
           03  FILLER           PIC X(17) VALUE "*TODAYS DATE*****".
           03  FILLER           PIC X(3) VALUE "***".
       01  PLINE4.
           03  FILLER           PIC X(7) VALUE " ".
       ...
       01  PDET-1.
           ...
           "ORDER**SHIP**SENT***B/O****PRICE**DISC*******NETT*".
           03  FILLER           PIC X(16) VALUE "TX**STORE*INV NO".
       01  PDET.
           03  P-NO             PIC Z(3).
           ...
           03  PDET-REST.
               ...
               05  P-PERC       PIC X(1).
               05  FILLER       PIC X(1) VALUE " ".
               05  P-NETT       PIC Z(5)9.99.
               05  FILLER       PIC X(1) VALUE " ".
               05  P-TAX        PIC X(3) VALUE " ".
      ...
      *
       ...
       CONTROL-000.
           ...
           MOVE 315 TO POS
           DISPLAY "** PRINT OF SUSPENDED CUSTOMER ORDERS **" AT POS
           MOVE 415 TO POS
           DISPLAY "****************************************" AT POS.
       CONTROL-003.
           Copy "PrinterAccept".
      ...
      *
       ...
       PR-012.
           ...
           MOVE " " TO PRINT-REC
           MOVE Ws-Print-Bold TO PRINT-REC
           WRITE PRINT-REC AFTER 1
           MOVE "** PRINT OF SUSPENDED CUSTOMER ORDERS **" TO PRINT-REC
           WRITE PRINT-REC AFTER 1
           MOVE Ws-Print-UnBold TO PRINT-REC
           MOVE WS-PRINT-COMP TO PRINT-REC
           WRITE PRINT-REC AFTER 1
           MOVE " " TO PRINT-REC.
       ...
       PR-020.
           ...
           COMPUTE WS-BO = B-ORDERQTY (SUB-1) -
      ...
      *     MOVE 4 TO INCR-TRANS.
           ...
           IF WS-INCR-ST1 NOT = 0
               MOVE "NO SUSPENDED ORDERS TO START, 'ESC' TO EXIT."
               TO WS-MESSAGE
               PERFORM ERROR1-000
      ...
      *     MOVE "Y" TO INCR-PRINTED.
           ...
           REWRITE INCR-REC
                  INVALID KEY NEXT SENTENCE.
           IF WS-INCR-ST1 NOT = 0
             MOVE "REGISTER BUSY ON REWRITE, IN 1 SEC GOING TO RETRY."
               TO WS-MESSAGE
               PERFORM ERROR1-000
               MOVE WS-INCR-ST1 TO WS-MESSAGE
               PERFORM ERROR-000
      ...
      *
       ...
       RP-010.
           ...
           IF WS-SLPARAMETER-ST1 = 23 OR 35 OR 49
              MOVE "SLPARAMETER NO SUCH FILE, 'ESC' TO EXIT." 
               TO WS-MESSAGE
              PERFORM ERROR1-000
