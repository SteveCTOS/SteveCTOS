      ...
      *     CANCEL WS-PROGRAM.
           ...
           IF WS-ANSWER = "35"
            ...
            IF WS-ANSWER = " 1"
                MOVE "GlMastMt" TO WS-PROGRAM.
            IF WS-ANSWER = " 2"
                MOVE "GlMastIq" TO WS-PROGRAM.
            IF WS-ANSWER = " 3"
                MOVE "GlNameIq" TO WS-PROGRAM.
            IF WS-ANSWER = " 4"
                MOVE "GlMastLy" TO WS-PROGRAM.
            IF WS-ANSWER = " 5"
                MOVE "GlMaLyIq" TO WS-PROGRAM.
            IF WS-ANSWER = " 6"
                MOVE "GlNameLy" TO WS-PROGRAM.
            IF WS-ANSWER = " 7"
                MOVE "GlJrnlMt" TO WS-PROGRAM.
            IF WS-ANSWER = " 8"
                MOVE "GlJrnBat" TO WS-PROGRAM.
            IF WS-ANSWER = " 9"
                MOVE "GlParmMt" TO WS-PROGRAM.
            IF WS-ANSWER = "10"
                MOVE "GlTrans"  TO WS-PROGRAM.
            IF WS-ANSWER = "11"
                MOVE "GlTranLy" TO WS-PROGRAM.
            IF WS-ANSWER = "12"
                MOVE "GlTranIq" TO WS-PROGRAM.
            IF WS-ANSWER = "13"
                MOVE "GlTrFuIq" TO WS-PROGRAM.
            IF WS-ANSWER = "14"
                MOVE "GlTrLyIq" TO WS-PROGRAM.
            IF WS-ANSWER = "15"
                MOVE "GlBudgMt" TO WS-PROGRAM.
            IF WS-ANSWER = "16"
      ...
      *          Move "GlMaint.Sub" TO Ws-Data-Name
       ...
       GET-015.
            ...
            CALL "&OPENFILELL" USING F-ERROR1
                                     ...
                                     F-OPENMODE.
            IF F-ERROR1 NOT = 0
                DISPLAY "OPENFILE GLMAINT.SUB ERROR"
                DISPLAY F-ERROR1
                STOP RUN.
