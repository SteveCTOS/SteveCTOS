      ...
      *
       ...
       CONTROL-005.
           MOVE 0310 TO POS.
           DISPLAY "*** CREDITOR REMITTANCE ENQUIRY ****" AT POS
           MOVE 0610 TO POS
           DISPLAY 
      ...
      *
       ...
       GET-000.
            ...
            MOVE "N" TO NEW-CRREMNO
                        WS-END.
            MOVE 0 TO WS-TOTALADJ WS-TOTAL-GROSS WS-DISC-PERC.
       ...
       GET-001.
            ...
            MOVE NUMERIC-RATE TO CRREM-ACC-NUMBER WS-NUMBER.
            IF SIGN-FOUND = 9
          ...
          IF F-EXIT-CH NOT = X"0A" AND NOT = X"0B"
            ...
            IF NEW-CRREMNO = "Y"
                MOVE 
            "NO REMITTANCE FOR THIS ACCOUNT, ENTER A VALID ACCOUNT."
                TO WS-MESSAGE
                PERFORM ERROR-000
                GO TO GET-001.
        GET-003.
      ...
      *          GO TO FILL-165.
        FILL-175.
            ...
            IF CRREM-COMPLETE NOT = "N" AND NOT = "P" AND NOT = "Y"
               MOVE 
            "THIS FIELD MUST BE EITHER N, P OR Y, 'ESC' TO RE-ENTER."
                  TO WS-MESSAGE
                  PERFORM ERROR-MESSAGE
                  GO TO FILL-175.
      ...
      *
       ...
       GL-GL-000.
           ...
           IF WS-REMI-ST1 NOT = 0
              ...
              MOVE "CRREMIT-FILE BAD START, PRESS 'ESC' TO RE-ENTER."
               TO WS-MESSAGE
               PERFORM ERROR-MESSAGE.
       GL-GL-999.
             EXIT.
      *
       ...
       RSN-005. 
           ...
           IF WS-REMI-ST1 NOT = 0
            ...
            MOVE "N"              TO NEW-CRREMNO.
            MOVE CRREM-YY         TO WS-REMI-YY
            MOVE CRREM-MM         TO WS-REMI-MM
            MOVE CRREM-F-L        TO WS-REMIT-F-L
            MOVE CRREM-ACC-NUMBER TO WS-NUMBER.
            MOVE CRREM-DISC-AMT   TO WS-DISC-AMT.
       RSN-999.
            EXIT.
