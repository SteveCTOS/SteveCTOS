      ...
      *
       ...
       RDNX-005.
           ...
           IF INCR-PRINTED = "Y" OR = "L"
               ...
               GO TO RDNX-999.
       RDNX-010.
           MOVE INCR-INVOICE     TO WS-ORDER WS-INVOICE.
           MOVE INCR-DATE        TO WS-ORDERDATE.
           MOVE INCR-KITNAME     TO WS-KIT-SAVE.
           MOVE INCR-KITQTY      TO WS-QTY.
           MOVE 0                TO WS-MFGQTY.
      ...
      *
       ...
       RNXR-005.
           ...
           IF WS-INCR-ST1 NOT = 0
               MOVE 0 TO WS-INCR-ST1
               MOVE "REGISTER BUSY ON READ, RNXR-005, 'ESC' TO RETRY."
                TO WS-MESSAGE
               PERFORM ERROR-MESSAGE
               GO TO RNXR-005.
           IF INCR-PRINTED = "Y" OR = "L"
      ...
      *
       ...
       RNSI-005.
           ...
           IF WS-STOCK-ST1 = 91
               ...
               GO TO RNSI-005.
           IF WS-STOCK-ST1 NOT = 0
               MOVE "STOCK RECORD BUSY IN READ-NEXT, 'ESC' TO RETRY."
               TO WS-MESSAGE
               PERFORM ERROR-MESSAGE
               MOVE 0 TO WS-STOCK-ST1
               GO TO RNSI-005.
      ...
      *
       ...
       OPEN-000.
           ...
           IF WS-SLPARAMETER-ST1 NOT = 0 
              MOVE 0 TO WS-SLPARAMETER-ST1
              MOVE "PARAMETER FILE OPEN ERROR, 'ESC' TO RETRY."
              TO WS-MESSAGE
              PERFORM ERROR-MESSAGE
              GO TO OPEN-000.
