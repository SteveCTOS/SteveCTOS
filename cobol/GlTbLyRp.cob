      ...
      *
       ...
       77  WS-HEAD-DESC         PIC X(25) VALUE " ".
       ...
       77  WS-SUBHEAD-DESC      PIC X(25) VALUE " ".
       ...
       01  HEAD1.
           ...
           "GENERAL LEDGER L/Y DETAIL TRIAL BALANCE".
      ...
      *
       ...
       CONTROL-000.
           ...
           MOVE 321 TO POS
           DISPLAY "** DETAIL L/Y TRIAL BALANCE **" AT POS
           MOVE 421 TO POS
           DISPLAY "******************************" AT POS.
       CONTROL-003.
           Copy "PrinterAccept".
      ...
      *
       ...
       RALT-020.
           ...
           MOVE GLTRANS-LY-NO            TO TRANS-PERIOD.
           MOVE GLTRANS-LY-LINE-DESC     TO TRANS-DESC.
           IF GLTRANS-LY-AMOUNT < 0
                MOVE 0                   TO TRANS-DEBIT
                ADD GLTRANS-LY-AMOUNT    TO WS-TOTAL-CREDIT
                                         WS-HEAD-CR-TOTAL
                                         WS-SUBHEAD-CR-TOTAL
                MOVE GLTRANS-LY-AMOUNT   TO TRANS-CREDIT
           ELSE
                MOVE 0                   TO TRANS-CREDIT
                ADD GLTRANS-LY-AMOUNT    TO WS-TOTAL-DEBIT
                                         WS-HEAD-DR-TOTAL
                                         WS-SUBHEAD-DR-TOTAL
                MOVE GLTRANS-LY-AMOUNT   TO TRANS-DEBIT.
           WRITE PRINT-REC FROM TRANS-LINE.
           MOVE " "                   TO PRINT-REC.
           ADD GLTRANS-LY-AMOUNT         TO WS-TRANS-TOTAL WS-TRANS-AMT.
           ADD 1 TO LINE-CNT.
       ...
       RALT-900.
           ...
           ADD WS-TRANS-TOTAL    TO GL-LY-OPEN-YEAR-BAL.
           MOVE GL-LY-OPEN-YEAR-BAL TO D-CLOSE.
           IF GL-LY-OPEN-YEAR-BAL NOT = GL-LY-BALANCE
      ...
      *
       ...
       PRR-000.
            ...
            MOVE WS-RANGE1 TO GL-LY-NUMBER.
      ...
      *CHECK FOR HEADER ACCOUNT
           IF WS-SUB = "    "
            IF WS-REST = "      "
               ...
               MOVE GL-LY-NUMBER        TO WS-HEAD-ACCOUNT
               MOVE GL-LY-DESCRIPTION   TO WS-HEAD-DESC
               MOVE GL-LY-OPEN-YEAR-BAL TO WS-HEAD-OPEN-BAL
               MOVE GL-LY-BALANCE       TO WS-HEAD-CLOSE-BAL
               MOVE " "              TO PRINT-REC
               WRITE PRINT-REC
               ADD 1 TO LINE-CNT
               GO TO PRR-050.
           ...
           IF WS-SUB NOT = "    "
            IF WS-REST = "      "
             IF WS-LAST-ACC-READ = "D"
               PERFORM PRINT-TOTAL-FOR-SUBHEADER
               MOVE GL-LY-NUMBER        TO WS-SUBHEAD-ACCOUNT
               MOVE GL-LY-DESCRIPTION   TO WS-SUBHEAD-DESC
               MOVE GL-LY-OPEN-YEAR-BAL TO WS-SUBHEAD-OPEN-BAL
               MOVE GL-LY-BALANCE       TO WS-SUBHEAD-CLOSE-BAL
               GO TO PRR-002
             ELSE
       ...
       PRR-050.
           IF WS-1ST-SUBHEAD-PRINT = "Y"
            IF WS-1ST-HEAD-PRINT = "Y"
               GO TO PRR-060.
           MOVE " " TO PRINT-REC DETAIL-LINE.
           MOVE GL-LY-NUMBER        TO D-ACCOUNT.
           MOVE GL-LY-P-B           TO D-TYPE.
           MOVE GL-LY-DESCRIPTION   TO D-DESC.
           MOVE GL-LY-OPEN-YEAR-BAL TO D-OPEN.
