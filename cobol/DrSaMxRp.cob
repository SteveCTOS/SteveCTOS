      ...
      *
       ...
       01  HEAD3.
           ...
           03  FILLER         PIC X(15) VALUE "REP  DISC".
           03  H3-BAL-SALE    PIC X(14) VALUE " ".
           03  H3-DESC        PIC X(66) VALUE " ".
       01  DETAIL-LINE.
       ...
       CONTROL-000.
           ...
           MOVE 315 TO POS
           DISPLAY "** DEBTORS REPORT BY HIGHEST SALES**" AT POS
           MOVE 415 TO POS
           DISPLAY "************************************" AT POS.
       CONTROL-003.
      ...
      *Z=A/C WITH NO SALESMAN
       ...
       PRR-015.
           ...
           IF WS-PRINT-TYPE = 2
            ...
            MOVE " " TO PRINT-REC
            WRITE PRINT-REC.
            MOVE "SALES YTD     SALES L/Y  PERC OF TOTAL  MARGIN YTD"
                TO H3-DESC.
            IF WS-PERIOD = "L"
            MOVE "SALES YTD     SALES L/Y  PERC OF TOTAL  MARGIN L/Y"
                TO H3-DESC.
      ...
      *     ACCEPT WS-DATE FROM DATE
       ...
       OPEN-038.
           ...
           IF WS-RANDOM-ST1 NOT = 0 
              MOVE
             "HIGH OPEN OUTPUT AT ANOTHER COMPUTER, 'ESC' TO EXIT."
              TO WS-MESSAGE
              PERFORM ERROR-MESSAGE
              GO TO OPEN-038.
       OPEN-999.
