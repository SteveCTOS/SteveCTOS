      ...
      *START OF DISPLAY FOR B/MATERIAL REGISTER INFO
       ...
       GET-025.
            ...
            MOVE 7            TO F-CBFIELDNAME.
            MOVE INCR-KITNAME TO F-NAMEFIELD.
            MOVE 15           TO F-CBFIELDLENGTH.
            PERFORM WRITE-FIELD-ALPHA.

            MOVE "KITQTY"    TO F-FIELDNAME.
            MOVE 6           TO F-CBFIELDNAME.
            MOVE INCR-KITQTY TO F-EDNAMEFIELDGROUP.
            MOVE 3           TO F-CBFIELDLENGTH.
            PERFORM WRITE-FIELD-GROUP.

            MOVE "KITSHPDQTY"    TO F-FIELDNAME.
            MOVE 10              TO F-CBFIELDNAME.
            MOVE INCR-KITSHPDQTY TO F-EDNAMEFIELDGROUP.
            MOVE 3               TO F-CBFIELDLENGTH.
            PERFORM WRITE-FIELD-GROUP.

            MOVE "KITDESC1"    TO F-FIELDNAME.
            MOVE 8             TO F-CBFIELDNAME.
            MOVE INCR-KITDESC1 TO F-NAMEFIELD.
            MOVE 20            TO F-CBFIELDLENGTH.
            PERFORM WRITE-FIELD-ALPHA.

            MOVE "KITDESC2"    TO F-FIELDNAME.
            MOVE 8             TO F-CBFIELDNAME.
            MOVE INCR-KITDESC2 TO F-NAMEFIELD.
            MOVE 20            TO F-CBFIELDLENGTH.
            PERFORM WRITE-FIELD-ALPHA.

            MOVE "KITPRICE"    TO F-FIELDNAME.
            MOVE 8             TO F-CBFIELDNAME.
            MOVE INCR-KITPRICE TO F-EDNAMEFIELD99Mil.
            MOVE 11             TO F-CBFIELDLENGTH.
            PERFORM WRITE-FIELD-99Mil.

            MOVE "KITCOMMENT"    TO F-FIELDNAME.
            MOVE 10              TO F-CBFIELDNAME.
            MOVE INCR-KITCOMMENT TO F-NAMEFIELD.
            MOVE 40              TO F-CBFIELDLENGTH.
            PERFORM WRITE-FIELD-ALPHA.
       GET-999.
            EXIT.
      ...
      *
       FILL-000.
            ...
            MOVE 2910 TO POS.
            DISPLAY 
            "THESE ARE INV, REPAIR, P/SLIP, QUOTE & C/NOTE FIELDS."
            AT POS.
      ...
      *
       ...
       FILL-2075.
            ...
            MOVE 15          TO F-CBFIELDLENGTH.
            PERFORM READ-FIELD-ALPHA.
            MOVE F-NAMEFIELD TO INCR-KITNAME.
            IF F-EXIT-CH = X"07"
               PERFORM CLEAR-FORM
               GO TO FILL-999.
            IF F-EXIT-CH = X"0C"
       ...
       FILL-2080.
            ...
            MOVE F-NAMEFIELD TO ALPHA-RATE
            PERFORM DECIMALISE-RATE
            MOVE NUMERIC-RATE TO INCR-KITQTY
                                 F-EDNAMEFIELDGROUP.
            PERFORM WRITE-FIELD-GROUP.
            IF F-EXIT-CH = X"07"
               PERFORM CLEAR-FORM
       ...
       FILL-2085.
            ...
            MOVE F-NAMEFIELD TO ALPHA-RATE
            PERFORM DECIMALISE-RATE
            MOVE NUMERIC-RATE TO INCR-KITSHPDQTY
                                 F-EDNAMEFIELDGROUP.
            PERFORM WRITE-FIELD-GROUP.
            IF F-EXIT-CH = X"07"
               PERFORM CLEAR-FORM
       ...
       FILL-2090.
            ...
            MOVE 20 TO F-CBFIELDLENGTH.
            PERFORM READ-FIELD-ALPHA.
            MOVE F-NAMEFIELD TO INCR-KITDESC1.
            IF F-EXIT-CH = X"07"
               PERFORM CLEAR-FORM
               GO TO FILL-999.
            IF F-EXIT-CH = X"0C"
       ...
       FILL-2095.
            ...
            MOVE 20 TO F-CBFIELDLENGTH.
            PERFORM READ-FIELD-ALPHA.
            MOVE F-NAMEFIELD TO INCR-KITDESC2.
            IF F-EXIT-CH = X"07"
               PERFORM CLEAR-FORM
               GO TO FILL-999.
            IF F-EXIT-CH = X"0C"
       ...
       FILL-2100.
            ...
            MOVE F-NAMEFIELD TO ALPHA-RATE
            PERFORM DECIMALISE-RATE
            MOVE NUMERIC-RATE TO INCR-KITPRICE
                                 F-EDNAMEFIELD99Mil.
            PERFORM WRITE-FIELD-99Mil.
            IF F-EXIT-CH = X"07"
               PERFORM CLEAR-FORM
       ...
       FILL-2105.
            ...
            MOVE 40 TO F-CBFIELDLENGTH.
            PERFORM READ-FIELD-ALPHA.
            MOVE F-NAMEFIELD TO INCR-KITCOMMENT.
            IF F-EXIT-CH = X"07"
               PERFORM CLEAR-FORM
               GO TO FILL-999.
            IF F-EXIT-CH = X"0C"
