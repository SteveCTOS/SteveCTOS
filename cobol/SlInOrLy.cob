      ...
      *
       ...
       FILL-000.
           ...
           PERFORM ERROR1-020.
           MOVE 2910 TO POS
           DISPLAY "Press <ESC> to Clear Screen, OR <END> to EXIT."
               AT POS.
       FILL-005.
           PERFORM ERROR-020.
           MOVE 3010 TO POS.
      ...
      *
       ...
       RSTT-000.
           ...
           IF F-NAMEFIELDRED1 = "R"
                MOVE 3 TO STTR-LY-TYPE.
           IF F-NAMEFIELDRED1 = "O"
                MOVE 4 TO STTR-LY-TYPE.
           IF F-NAMEFIELDRED1 = "C"
                MOVE 6 TO STTR-LY-TYPE.
           IF F-NAMEFIELDRED1 = "Q"
      ...
      *     IF F-NAMEFIELDRED1 NOT = "C"
           ...
           MOVE STTR-LY-UNIT         TO B-UNIT (SUB-1).
           MOVE STTR-LY-SALES-VALUE  TO B-NETT (SUB-1).
           GO TO RSTT-050.
       RSTT-020.
           MOVE COMMENT-LY-FIELDS    TO C-LINE (SUB-1).
       RSTT-050.
           ADD 1 TO SUB-1.
      ...
      *
       ...
       FIND-020.
            ...
            MOVE 8 TO F-CBFIELDNAME.
            MOVE INCR-LY-CODE TO F-NAMEFIELD.
            ...
            MOVE INCR-LY-SALES TO F-NAMEFIELD.
            ...
            IF F-NAMEFIELDRED1 = "I"
             IF WS-DRTRANS-ST1 = 23 OR 35 OR 49
                MOVE INCR-LY-INVCRED-AMT TO WS-PAYED
             ELSE
                COMPUTE WS-PAYED = 
