      ...
      *
       ...
       GET-010.
            ...
            IF WS-ANSWER NOT = " 1" AND NOT = " 2" AND NOT = " 3"
                     ...
                     AND NOT = "XX"
                MOVE "Selection Must Be Between 1 & 12, Re-Enter."
                TO WS-MESSAGE
                PERFORM ERROR-000
      ...
      *     CANCEL WS-PROGRAM.
           ...
           IF WS-ANSWER = "35"
            ...
            IF WS-ANSWER = " 1"
                MOVE "GlMastRp" TO WS-PROGRAM.
            IF WS-ANSWER = " 2"
                MOVE "GlJrnLRp" TO WS-PROGRAM.
            IF WS-ANSWER = " 3"
                MOVE "GlJrnARp" TO WS-PROGRAM.
            IF WS-ANSWER = " 4"
                MOVE "GlTrSrch" TO WS-PROGRAM.
            IF WS-ANSWER = " 5"
                MOVE "GlTrBaRp" TO WS-PROGRAM.
            IF WS-ANSWER = " 6"
                MOVE "GlTrbSRp" TO WS-PROGRAM.
            IF WS-ANSWER = " 7"
                MOVE "GlTbLyRp" TO WS-PROGRAM.
            IF WS-ANSWER = " 8"
                MOVE "GlInStRp" TO WS-PROGRAM.
            IF WS-ANSWER = " 9"
                MOVE "GlInGpRp" TO WS-PROGRAM.
            IF WS-ANSWER = "10"
                MOVE "GlBalSRp" TO WS-PROGRAM.
            IF WS-ANSWER = "11"
                MOVE "GlBlGpRp" TO WS-PROGRAM.
            IF WS-ANSWER = "12"
                MOVE "GlAsRgRp" TO WS-PROGRAM.
