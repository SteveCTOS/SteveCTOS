      ...
      *
       ...
       77  WS-BELOW-BODY        PIC X VALUE " ".
       77  WS-PRINT-TOTALS      PIC X VALUE " ".
       77  WS-REPAIR-ITEM       PIC X VALUE " ".
       ...
       77  WS-QUOTE-ACINQ       PIC X(8) VALUE "SlRpAcIq".
       77  WS-QUOTE-STINQ       PIC X(8) VALUE "SlRpStIq".
       ...
       01  WS-HYLA-TYPE-LINE.
           03  FILLER             PIC X(15) VALUE " ".
           03  WS-HYLA-TYPE       PIC X(30) VALUE "*REPAIR QUOTE*".
       ...
       01  WS-HYLA-TYPE-LINE2.
           03  FILLER             PIC X(15) VALUE " ".
           03  WS-HYLA-TYPE2      PIC X(30) VALUE "*REPAIR QUOTE*".
      ...
      *     PERFORM CLEAR-020.
           MOVE 0320 TO POS
           DISPLAY "** STOCK REPAIR PROGRAM **" AT POS
           MOVE 0420 TO POS
           DISPLAY "**************************" AT POS.
       CONTROL-003.
           Copy "PrinterAccept".
      ...
      *<F3> CHANGE OF P-ORDER NUMBER.
           ...
           MOVE 3010 TO POS
           DISPLAY "WRITING REPAIR REGISTER..............      " AT POS
      ...
      *          GO TO WR-001X.
           ...
           MOVE "***** STOCK REPAIR BOOKING IN SLIP *****" TO HEAD1-NAME
           WRITE PRINT-REC FROM HEAD1
       ...
       WR-001X2.
           ...
           MOVE "REPAIR INSTRUCTIONS :" TO HEAD2-PH-REQU
      ...
      *      ELSE
       ...
       WR-015.
           WRITE PRINT-REC FROM WS-STOCK-LINE
      ...
      *       IF LINE-CNT > 48
      *        ADD 1 TO PAGE-CNT
      *        MOVE PAGE-CNT TO W-NEW-PAGE
      *        WRITE PRINT-REC FROM W-CONTINUE-LINE
      *        MOVE " " TO PRINT-REC
      *        WRITE PRINT-REC BEFORE PAGE
      *        PERFORM WR-003.
              
           IF WS-ANSWER = "1" OR = "2" OR = "3" OR = "W"
            IF LINE-CNT > 58
              ADD 1 TO PAGE-CNT
              MOVE PAGE-CNT TO W-NEW-PAGE
              WRITE PRINT-REC FROM W-CONTINUE-LINE
      ...
      *        PERFORM WR-003.
           ...
           MOVE "     *GROSS REPAIR T" TO WSW-DESCRIPTION
           ...
           MOVE "     * NETT REPAIR T" TO WSW-DESCRIPTION
           MOVE "OTAL EXCLUDING VAT *" TO WSW-DESCRIPTION2
           ...
           WRITE PRINT-REC FROM WS-STOCK-LINE.
           MOVE " " TO WS-STOCK-LINE PRINT-REC
           MOVE "      *************T" TO WSW-DESCRIPTION
           MOVE "OTAL REPAIR AMOUNT *" TO WSW-DESCRIPTION2
      ...
      *       MOVE " " TO PRINT-REC.
           ...
           WRITE PRINT-REC.
      ********************************************
      * FAX-JOBNUMBER IS ONLY FOR EPS TYPE FAXES *
      ********************************************
      ...
      *
       ...
       CPOR-010.
           ...
           IF WS-NEWORDER = "N" OR = "P"
             ...
             PERFORM FIND-INFO
           ELSE
             MOVE "THIS REPAIR IS COMPLETE, 'ESC' TO EXIT."
             TO WS-MESSAGE
             PERFORM ERROR-MESSAGE
             GO TO CPOR-999.
           PERFORM ERROR1-020
      ...
      *
       ...
       GET-010.
            ...
            MOVE " " TO WS-MESSAGE
                        ...
                        WS-SOLD-BY.
      *************************************************************
      * WS-REPAIR-ITEM: P=PART FOR REPAIR, R=ITEM BEING REPAIRED. *
      *************************************************************
            ...
            MOVE 2910 TO POS
           DISPLAY
           "ENTER A/C # & <RETURN> TO CREATE A REPAIR, ENTER " &
           "REPAIR #  &  <F5>" AT POS
           MOVE 3010 TO POS
           DISPLAY
           ...
           " P/ORDER #." AT POS.
            ...
            IF F-EXIT-CH = X"14"
             IF WS-IMM-PR = "Y"
                MOVE "Press 'ALT-F11' To Reprint This Repair Slip."
                TO WS-MESSAGE
                PERFORM ERROR-MESSAGE
                GO TO GET-010.
            IF F-EXIT-CH = X"93"
            ...
            IF F-NAMEFIELDRED1 = "S"
                AND F-NAMEFIELDRED7 NOT = "TOCK"
                   ...
                   GO TO GET-010.
      *****************************************************
      * 'F3' KEY, TO FIND REPAIR & CHANGE P/ORDER NUMBER  *
      *****************************************************
           IF F-EXIT-CH = X"17"
           ...
           IF F-EXIT-CH = X"1F"
            ...
            IF WS-PASSWORD-VALID = "N"
               GO TO GET-010.
      **********************************************
      * 'F5' KEY, TO FIND OLD REPAIR AND DISPLAY   *
      **********************************************
           IF F-EXIT-CH = X"19"
                MOVE "          " TO ALPHA-RATE
                MOVE F-NAMEFIELDRED7 TO ALPHA-RATE
           ...
           IF F-EXIT-CH = X"19" OR = X"9B" OR = X"C7"
            ...
            ELSE
             IF WS-NEWORDER = "C"
                ...
                GO TO GET-010.
      ****************************************
      * 'F10' KEY, TO DELETE COMPLETE REPAIR *
      ****************************************
           IF F-EXIT-CH = X"1F"
              MOVE "          " TO ALPHA-RATE
              MOVE F-NAMEFIELDRED7 TO ALPHA-RATE
           ...
           IF F-EXIT-CH = X"1F"
            IF WS-NEWORDER = "Y"
              MOVE "REPAIR NOT FOUND IN THE SYSTEM, CAN'T DELETE."
              TO WS-MESSAGE
              PERFORM ERROR-MESSAGE
              GO TO GET-010.
           IF F-EXIT-CH = X"1F"
       ...
       GET-011.
           IF F-EXIT-CH = X"1F"
            IF WS-NEWORDER = "N"
              ...
              PERFORM CLEAR-010
              MOVE 2910 TO POS
              DISPLAY "ARE YOU SURE ABOUT DELETING THE ENTIRE REPAIR."
              AT POS
              MOVE 3010 TO POS
       ...
       GET-012.
           ...
           IF F-EXIT-CH = X"1F"
            IF WS-NEWORDER = "N"
             IF WS-DIS = "Y"
                ...
                AT POS
                MOVE "REPAIR REVERSED, No:" TO WS-DAILY-1ST
           ...
           IF DR-SUPPLY-Y-N = "N"
               MOVE 
            "GOODS CANNOT BE SUPPLIED ON THIS A/C, 'ESC' TO CONTINUE." 
               TO WS-MESSAGE
       ...
       GET-020.
            ...
            IF F-EXIT-CH = X"01"
             IF WS-NEWORDER NOT = "Y"
              IF WS-MUST-PRINT = "Y"
                MOVE "THE REPAIR BEEN CHANGED, PRINT THIS COPY."
                   TO WS-MESSAGE
                PERFORM ERROR-MESSAGE
                GO TO GET-150
              ELSE
       ...
       GET-111.
           IF WS-NEWORDER = "C"
                MOVE 2910 TO POS
                DISPLAY "REPAIR INVOICED ON INVOICE No:" AT POS
                ADD 32 TO POS
            IF INCR-TRANS = 1
           ...
           IF WS-NEWORDER = "P" OR = "N"
            IF WS-ABOVE-BODY = "1"
             IF INCR-TRANS = 8
                MOVE "A REPAIR WITH THIS REF. HAS BEEN ENTERED ALREADY."
                TO WS-MESSAGE
                PERFORM ERROR1-000
           ...
           IF WS-NEWORDER = "N"
            IF WS-ABOVE-BODY NOT = "1"
              MOVE 2910 TO POS
              DISPLAY "  THIS REPAIR HAS ALREADY BEEN ENTERED," AT POS
              MOVE 3010 TO POS
              DISPLAY "DO YOU WISH TO SEE THIS OLD REPAIR, Y OR N: [ ]"
              AT POS
              ADD 45 TO POS
      ...
      *<CODE-GO> = INSERT THE FOLLOWING MESSAGE
           IF F-EXIT-CH = X"9B" OR = X"C7"
            IF WS-REPAIR-ITEM = "P"
                MOVE "*** ITEMS SENT "     TO B-STOCKNUMBER (SUB-1)
                MOVE "IN FOR REPAIR ***"   TO C-LINE (SUB-1)
      ...
      *****************************************************************
           IF F-EXIT-CH = X"89" AND SUB-25 < 200
            ...
            IF F-EXIT-CH = X"01" AND F-INDEX = 1
              ...
              IF WS-MUST-PRINT = "Y"
               MOVE
            "YOU SHOULD PRINT THIS REPAIR AS A CHANGE HAS BEEN MADE."
               TO WS-MESSAGE
               PERFORM ERROR-000
                MOVE "1" TO WS-ABOVE-BODY
                GO TO FILL-999
      ...
      *
       ...
       R-KIT-010.
           ...
           IF WS-TOOLKIT-ST1 NOT = 0
               MOVE 
           "THERE'S AN ERROR READING THE KIT FILE, 'ESC' TO RETRY."
               TO WS-MESSAGE
               PERFORM ERROR1-000
      ...
      *
       ...
       CAN-TRANS-000.
           ...
           IF WS-STTRANS-ST1 NOT = 0
               MOVE 
               "ST-TRANS BUSY CAN-TRANS-000 READ-LOCK, 'ESC' TO RETRY."
               TO WS-MESSAGE
               PERFORM ERROR1-000
               MOVE WS-STTRANS-ST1 TO WS-MESSAGE
               PERFORM ERROR-MESSAGE
       ...
       CAN-TRANS-002.
            DELETE STOCK-TRANS-FILE
               INVALID KEY NEXT SENTENCE.
           IF WS-STTRANS-ST1 NOT = 0
               MOVE "ST-TRANS FILE BUSY ON DELETE, 'ESC' TO RETRY."
               TO WS-MESSAGE
               PERFORM ERROR1-000
               MOVE WS-STTRANS-ST1 TO WS-MESSAGE
               PERFORM ERROR-MESSAGE
      ...
      *
       ...
       RUN-010.
           ...
           IF WS-WORKTOTAL2 > 9999999.99
              MOVE "** YOUR REPAIR VALUE HAS EXCEEDED R9,999,999.99 **"
              TO WS-MESSAGE
              PERFORM ERROR-000
              MOVE " *  YOU MUST 'ALT-ESC' ON YOUR LAST STOCK LINE ! *"
              TO WS-MESSAGE
              PERFORM ERROR1-MESSAGE
              MOVE " " TO WS-MESSAGE
              PERFORM ERROR-020
      ...
      *
       ...
       WRIC-060.
            ...
            IF WS-INCR-ST1 NOT = 0
                MOVE 
            "REGISTER BUSY ON REWRITE <WRIC-060>, 'ESC' TO RE-TRY"
                TO WS-MESSAGE
               PERFORM ERROR1-000
      ...
      *
       ...
       CRS-060.
           ...
           IF WS-INCR-ST1 NOT = 0
               MOVE
           "BUSY CHECKING READ-REGISTER-NEXT CRS-060, 'ESC' TO RETRY."
                TO WS-MESSAGE
               PERFORM ERROR1-000
               MOVE WS-INCR-ST1 TO WS-MESSAGE
               PERFORM ERROR-MESSAGE
      ...
      *
       ...
       RIR-006.
           IF WS-INCR-ST1 = 23 OR 35 OR 49
               ...
               GO TO RIR-999.
           IF WS-INCR-ST1 NOT = 0
               MOVE "REGISTER BUSY <RIR-005>, PRESS 'ESC' TO RETRY"
               TO WS-MESSAGE
               PERFORM ERROR1-000
               MOVE WS-INCR-ST1 TO WS-MESSAGE
               PERFORM ERROR-MESSAGE
               ...
               GO TO RIR-005.
           IF INCR-PRINTED = "Y" OR = "L"
               MOVE "THIS REPAIR HAS BEEN ENTERED AS AN ORDER."
               TO WS-MESSAGE
               PERFORM ERROR-000
      ...
      *
       ...
       DIR-010.
           MOVE 2910 TO POS.
           DISPLAY "DELETING REPAIR-REGISTER................" AT POS.
           DELETE INCR-REGISTER
              INVALID KEY NEXT SENTENCE.
           IF WS-INCR-ST1 NOT = 0
              MOVE 
            "REGISTER BUSY ON DELETE <DIR-010>, 'ESC' TO RETRY"
              TO WS-MESSAGE
               PERFORM ERROR1-000
               MOVE WS-INCR-ST1 TO WS-MESSAGE
               PERFORM ERROR-MESSAGE
      ...
      *
       ...
       DST-000.
           MOVE 2910 TO POS.
           DISPLAY "DELETING ST-REPAIR-TRANSACTIONS........." AT POS.
           MOVE 1 TO SUB-1.
           MOVE WS-INVOICE TO STTR-REFERENCE1.
           MOVE 3          TO STTR-TYPE.
      ...
      *
       ...
       RSTT-000.
           MOVE 2910 TO POS
           DISPLAY "READING ST-REPAIR-TRANSACTIONS.........." AT POS.
           MOVE 1          TO SUB-1
           MOVE 3          TO STTR-TYPE
           MOVE WS-INVOICE TO STTR-REFERENCE1
           MOVE 0          TO STTR-TRANSACTION-NUMBER.
      ...
      *
       ...
       RTERM-010.
            ...
            IF WS-SLPARAMETER-ST1 NOT = 0
               MOVE "PARAM-TERM FILE BUSY, PRESS 'ESC' TO RETRY"
               TO WS-MESSAGE
               PERFORM ERROR1-000
      ...
      *
       ...
       RDELIV-010.
            ...
            IF PA-TYPE > 3
                GO TO RDELIV-999.
            IF WS-SLPARAMETER-ST1 NOT = 0
               MOVE "PARAM-DEL FILE BUSY ON READ, 'ESC' TO RETRY"
               TO WS-MESSAGE
               PERFORM ERROR1-000
               MOVE WS-SLPARAMETER-ST1 TO WS-MESSAGE
               PERFORM ERROR-MESSAGE
      ...
      *
       ...
       R-ST-005.
           ...
           IF WS-STOCK-ST1 = 23 OR 35 OR 49
               ...
               GO TO R-ST-999.
           IF WS-STOCK-ST1 NOT = 0
               MOVE "STOCK RECORD IN USE R-ST-005, 'ESC' TO RETRY."
               TO WS-MESSAGE
               PERFORM ERROR1-000
      ...
      *
       ...
       CH-ST-005.
           ...
           IF WS-STOCK-ST1 = 23 OR 35 OR 49
               ...
               GO TO CH-ST-999.
           IF WS-STOCK-ST1 NOT = 0
               MOVE "STOCK RECORD IN USE CH-ST-005, 'ESC' TO RETRY."
               TO WS-MESSAGE
               PERFORM ERROR1-000
               MOVE WS-STOCK-ST1 TO WS-MESSAGE
               PERFORM ERROR-MESSAGE
      ...
      *
       ...
       SFRN-001.
           START STOCK-MASTER KEY NOT < ST-KEY
               INVALID KEY NEXT SENTENCE.
           IF WS-STOCK-ST1 NOT = 0
               MOVE "START STOCK RECORD SFRN-001, 'ESC' TO RETRY."
               TO WS-MESSAGE
               PERFORM ERROR1-000
               MOVE WS-STOCK-ST1 TO WS-MESSAGE
               PERFORM ERROR-MESSAGE
      ...
      *
       ...
       RNSI-005.
           ...
           IF WS-STOCK-ST1 = 10
               ...
               GO TO RNSI-999.
           IF WS-STOCK-ST1 = 91
               MOVE "STOCK RECORD ERC 91 RNSI-005, 'ESC' TO RETRY."
               TO WS-MESSAGE
               PERFORM ERROR1-000
               MOVE WS-STOCK-ST1 TO WS-MESSAGE
               PERFORM ERROR-MESSAGE
               ...
               GO TO RNSI-005.
           IF WS-STOCK-ST1 NOT = 0
               MOVE "STOCK RECORD IN USE RNSI-005, 'ESC' TO RETRY."
               TO WS-MESSAGE
               PERFORM ERROR1-000
               MOVE WS-STOCK-ST1 TO WS-MESSAGE
               PERFORM ERROR-MESSAGE
      ...
      *
       ...
       RPREV-005.
           ...
           IF WS-STOCK-ST1 = 10
               ...
               GO TO RPREV-999.
           IF WS-STOCK-ST1 = 91
               MOVE "STOCK RECORD ERC 91 RPREV-005, 'ESC' TO RETRY."
               TO WS-MESSAGE
               PERFORM ERROR1-000
               MOVE WS-STOCK-ST1 TO WS-MESSAGE
               PERFORM ERROR-MESSAGE
               ...
               GO TO RPREV-005.
           IF WS-STOCK-ST1 NOT = 0
               MOVE "STOCK RECORD IN USE RPREV-005, 'ESC' TO RETRY."
               TO WS-MESSAGE
               PERFORM ERROR1-000
               MOVE WS-STOCK-ST1 TO WS-MESSAGE
               PERFORM ERROR-MESSAGE
      ...
      *
       ...
       RP-010.
           ...
           IF WS-SLPARAMETER-ST1 = 23 OR 35 OR 49
               ...
               EXIT PROGRAM.
           IF WS-SLPARAMETER-ST1 NOT = 0
              MOVE "PARAMETER RECORD BUSY ON READ, 'ESC' TO RE-TRY."
              TO WS-MESSAGE
               PERFORM ERROR1-000
               MOVE WS-SLPARAMETER-ST1 TO WS-MESSAGE
               PERFORM ERROR-MESSAGE
      ...
      *
       ...
       REWP-000.
           ...
           IF WS-SLPARAMETER-ST1 = 23 OR 35 OR 49
               MOVE 
            "PARAMETER REC NOT UPDATED ON REWRITE, CALL YOUR SUPERVISOR"
                TO WS-MESSAGE
                PERFORM ERROR-MESSAGE
                EXIT PROGRAM.
           IF WS-SLPARAMETER-ST1 NOT = 0
      ...
      *
       ...
       SCROLL-030.
            ...
            IF B-STOCKPRICE (SUB-1) > 0
                ...
                PERFORM WRITE-FIELD-AMOUNT
            ELSE
                MOVE " "                  TO F-EDNAMEFIELDAMOUNT
                PERFORM WRITE-FIELD-ALPHA.

            MOVE "STOCKCOST" TO F-FIELDNAME
            MOVE 9           TO F-CBFIELDNAME
            MOVE 9           TO F-CBFIELDLENGTH.
            IF B-STOCKCOST (SUB-1) > 0
             IF WS-COST-DISPLAY = "Y"
                MOVE B-STOCKCOST (SUB-1) TO F-EDNAMEFIELDAMOUNT
                PERFORM WRITE-FIELD-AMOUNT
            ELSE
      ...
      *
       ...
       CI-000.
             MOVE 3010 TO POS.
             DISPLAY "CANCELLING REPAIR TRANSACTIONS ......." AT POS.
             MOVE 1 TO SUB-1.
             IF WS-NEWORDER NOT = "Y"
                   GO TO CI-900.
       CI-010.
      ...
      *
       ...
       RDFXPRM-010.
           ...
           IF WS-FAX-ST1 = 23 OR 35 OR 49
                MOVE
                "WE HAVE A PROBLEM IN THE FAXPARMETER FILE ON READ"
                TO WS-MESSAGE
                PERFORM ERROR1-000
                ...
                GO TO RDFXPRM-010.
           IF WS-FAX-ST1 NOT = 0
                MOVE "FAX RECORD BUSY ON READ, PRESS 'ESC' TO RETRY"
                TO WS-MESSAGE
                PERFORM ERROR1-000
                MOVE WS-FAX-ST1 TO WS-MESSAGE
                PERFORM ERROR-MESSAGE
