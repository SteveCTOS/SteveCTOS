      ...
      *
       ...
       GET-000.
           MOVE 0310 TO POS
           DISPLAY "** TRANSFER REGISTER RECORDS TO A NEW ACCOUNT **"
           AT POS
           MOVE 0410 TO POS
           DISPLAY "************************************************"
           AT POS.
       ...
       GET-600.
           ...
           MOVE 2001 TO POS
           DISPLAY 
           "DO YOU WISH TO RENAME THE DR-TRANS & MOVE SALES ON THE" &
           " DR-MASTER FILE: [ ]"
           AT POS
           ADD 72 TO POS
      ...
      *
       ...
       RBO-000.
            MOVE 2910 TO POS.
            DISPLAY "Changing Stock-Trans To New Account....          "
            AT POS.
            IF WS-ANSWER1 = "Y"
            ...
            ELSE
                MOVE WS-NUM  TO STTR-REFERENCE1
      ...
      *
       ...
       RRR-000.
            MOVE 2910 TO POS.
            DISPLAY "Changing Register Records To New Account...      "
               AT POS.
            IF WS-ANSWER1 = "Y"
      ...
      *
       ...
       RDRTR-030.
           ...
           MOVE INCR-INVCRED-COST    TO WS-COST.
           MOVE WS-NEWDEBTORNUMBER   TO DR-ACCOUNT-NUMBER.
       ...
       RDRTR-035.
           COMPUTE WS-SALEAMT =
                    (INCR-INVCRED-AMT - INCR-TAX - INCR-ADDONS) * -1.
           MOVE DRTR-AMT-OUTSTANDING TO WS-AMT-OF-INVOICE.
           MOVE INCR-INVCRED-COST    TO WS-COST.
           MOVE WS-NEWDEBTORNUMBER   TO DR-ACCOUNT-NUMBER.
           COMPUTE WS-AMT-OF-INVOICE = WS-AMT-OF-INVOICE * -1.
      ...
      *
       ...
       UP-DR-020.
           IF WS-OLDDEBTORNUMBER = DR-ACCOUNT-NUMBER
            IF DR-DATE-LAST-SALE < INCR-DATE
               MOVE INCR-DATE TO DR-DATE-LAST-SALE.
           PERFORM GET-SYSTEM-Y2K-DATE.
           MOVE INCR-DATE TO WS-AGE-DATE.
           ...
           SUBTRACT WS-AGE-MM FROM WS-MM.
            ...
            IF WS-MM = 0
               ADD WS-AMT-OF-INVOICE TO DR-CURRENT
                                        DR-BALANCE
               ADD WS-SALEAMT        TO DR-SALES-PTD
                                        DR-SALES-YTD
               ADD WS-COST           TO DR-COST-PTD
                                        DR-COST-YTD
               GO TO UP-DR-030.
            IF WS-MM = 1
      ...
      *
       ...
       RTERM-010.
            ...
            IF WS-SLPARAMETER-ST1 NOT = 0
               MOVE "PARAMETER TERMS BUSY ON READ-NEXT, 'ESC' TO RETRY."
               TO WS-MESSAGE
               PERFORM ERROR1-000
