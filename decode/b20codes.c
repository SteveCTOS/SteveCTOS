...
int main(int argc, char *argv[])
{
  ...
  add_field(0x11, "SCROLL-UP   (A-pgup)");
  add_field(0x12, "RIGHT       (right)");
  add_field(0x13, "SCROLL-DN   (A-pgdn)");
  ...
  add_field(0x1b, "GO          (F12)");
  add_field(0x1c, "F7          (F7)");
  add_field(0x1d, "F8          (F8)");
  add_field(0x1e, "F9          (F9)");
  add_field(0x1f, "F10         (F10)");
  add_field(0x89, "CODE-TAB    (A-tab)");
  add_field(0x8f, "CODE-MOVE   (AS-M)");
  add_field(0x95, "CODE-F1     (A-1)");
  add_field(0x96, "CODE-F2     (A-2)");
  add_field(0x97, "CODE-F3     (A-3)");
  add_field(0x98, "CODE-F4     (A-4)");
  add_field(0x99, "CODE-F5     (A-5)");
  add_field(0x9a, "CODE-F6     (A-6)");
  add_field(0x9b, "CODE-GO     (A-F12)");
  add_field(0x9c, "CODE-F7     (A-7)");
  add_field(0x9d, "CODE-F8     (A-8)");
  add_field(0x9e, "CODE-F9     (A-9)");
  add_field(0x9f, "CODE-F10    (A-0)");
  add_field(0xd5, "SHIFT-F1    (S-F1)");
  add_field(0xd6, "CODE-SHIFT-V(AS-V)");
  ...
  add_field(0xfe, "CODE-BS     (A-bckspc)");
  add_field(0xff, "CODE-DELETE (A-del)");
  add_field(0x91, "CODE-SCR-UP (F11)");
  add_field(0x93, "CODE-SCR-DN (A-F11)");
  add_field(0x87, "CODE-CANCEL (C-e(05))");
  add_field(0x8a, "CODE-RETURN (C-r(12))");
  add_field(0x8b, "CODE-DOWN   (A-down)");
  //add_field(0x80, "UNUSED      (none)");
  //add_field(0x81, "UNUSED      (none)");
  //add_field(0x82, "UNUSED      (none)");
